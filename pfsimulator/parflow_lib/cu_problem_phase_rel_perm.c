...
PFModule  *CU_PhaseRelPermInitInstanceXtra(
                                        Grid *  grid,
                                        double *temp_data)
{
  PFModule      *this_module = ThisPFModule;
...
void  CU_PhaseRelPermFreeInstanceXtra()
{
  PFModule *this_module = ThisPFModule;
  PublicXtra *public_xtra = (PublicXtra*)PFModulePublicXtra(this_module);
...
PFModule   *CU_PhaseRelPermNewPublicXtra()
{
  PFModule      *this_module = ThisPFModule;
...
void  CU_PhaseRelPermFreePublicXtra()
{
  PFModule    *this_module = ThisPFModule;
  PublicXtra  *public_xtra = (PublicXtra*)PFModulePublicXtra(this_module);
...
int  CU_PhaseRelPermSizeOfTempData()
{
  PFModule      *this_module = ThisPFModule;
  PublicXtra    *public_xtra = (PublicXtra*)PFModulePublicXtra(this_module);
